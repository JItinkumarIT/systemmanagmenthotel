...
class Login_Window:
    def __init__(self,root):
        ...
        img1 = Image.open("E:/hms/2-AI-invades-automobile-industry-in-2019.jpeg")
        ...
        title=Label(bg_lbl,text="HOTEL MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="purple",fg="gold")
        ...
        myname=Label(self.root,text="Developed By:JITIN KUMAR",fg="black",bg="white",font=("italic",18,"bold"))
        myname.place(x=0,y=5)
       ...
       # img13 = img13.resize((550,120), Image.ANTIALIAS)
        ...
        frame.place(x=510,y=200,width=340,height=430)
         
        img1=Image.open("E:/hms/LoginIconAppl.png")
        img1=img1.resize((90,90),Image.ANTIALIAS)
        self.photoimage1=ImageTk.PhotoImage(img1)
        lblimg1=Label(image=self.photoimage1,bg="black",borderwidth=0)
        lblimg1.place(x=630,y=200,width=90,height=90)
        ...
        img3=Image.open("E:/hms/lock-512.png")
    ...
    def login(self):
        ...
        elif self.txtuser.get()=="JITIN" and self.txtpass.get()=="KUMAR":
            messagebox.showinfo("Success","Welcome to the JITIN'S (*_*) World.")
        else:
            conn=mysql.connector.connect(host="localhost",user="root",password="DOB10jun@123",database="management")
...
class Register:
    def __init__(self,root):
        ...
        # ============bg image==================
        self.bg=ImageTk.PhotoImage(file="E:/hms/employee_img2.jpg")
        bg_lbl=Label(self.root,image=self.bg)
        bg_lbl.place(x=0,y=0,relwidth=1,relheight=1)

        
        # ============left image==================
        self.bg1=ImageTk.PhotoImage(file="E:/hms/thought-good-morning-messages-LoveSove.jpg")
        left_lbl=Label(self.root,image=self.bg1)
        left_lbl.place(x=0,y=50,width=500,height=650)
        ...
        # =================buttons========================
        img=Image.open("E:/hms/register-now-button1.jpg")
        ...
        img1=Image.open("E:/hms/loginpng.png")
